...
static const char *fonts[]          = { "JetBrainsMonoNerdFontPropo:size=10:antialias=true:autohint=true" };
static const char dmenufont[]       = "JetBrainsMonoNerdFontPropo:size=10:antialias=true:autohint=true";
...
static const Rule rules[] = {
	...
	{ "minecraft-launcher",  NULL,       NULL,       0,            0,           -1  },
	{ "Minecraft Launcher",  NULL,       NULL,       0,            0,           -1  },
	{ "Minecraft",           NULL,       NULL,       0,            0,           -1  },
};

static const char *glyphs[] = { "", "", "", "", "", "󰍳", "󰾧", "" };
static const ClassGlyph classGlyphs[] = {
	{ "lukas@lukas-Think",    2  },
	{ "lfrun",                3  },
    { "Open3D",               7  },
	{ "pdf",                  4  },
